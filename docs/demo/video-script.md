...
**At a glance: 756 words, 259.2s of narration at 175 words per minute (about 4:19), inside the 4:15-4:45 hard bound.**
...
| Field              | Detail                                                                                                                                                                                                                                                             |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Runtime target** | 4:15-4:45, hard bound. 756 words of narration is 259.2s (about 4:19). The cut film is expected a little longer once the recorder's natural gaps between lines and beats are in                                                                                     |
...
| `shot-1`-`shot-10` | The ten walkthrough beats                                                                           | budgeted | 204.7s      |
...
| **Total**          | **0:00-4:20** | **260** | **756** |

Each row's Seconds is that beat's own lines, individually rounded to the nearest second and summed - the same rule the
detailed tables below use, so a row here always matches its rows there. The precise, unrounded total is 259.2s (4:19.2);
summing already-rounded lines instead adds 0.8s, landing this ladder at 260s (4:20).
...
| **Precise narration duration**                 | 756 words / 175 wpm = 259.2s, about 4:19                                                                                                                                                            |
...
| **Hard bound**                                 | 4:15-4:45 (255-285s). The precise total clears the floor by 4.2s and sits 25.8s under the ceiling; the ladder clears it by 5s and sits 25s under                                                    |
