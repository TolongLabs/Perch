...
| ![The Deck](assets/screens/04-deck.png)              | The invite link opens here, on a phone, with no account and no sign-up. She swipes each reel right to keep, left to pass, or up to spend the one Must Go she gets, and the count goes down. Her three friends swiped when she sent the link, so the tally is never waiting on everyone at once                                                                           |
...
| ![The Desk](assets/screens/06-desk.png)              | She drags a card into a slot and Plan The Days orders each day around whatever she has fixed. Day 2 has just turned gold: the same three places in a worse order, so it still fits but spends 9 more minutes in transit than the order the scheduler would have chosen. A plus and a minus on each day heading open and close a second stop in a period, up to six a day |
...
| ![The Book](assets/screens/08-book.png)              | What the group keeps. Each day leads with its stops as pictures, the same poster frames the reels were swiped on, with the dwell, the ringgit and the yen under every entry. The drawing of the day's real route sits at the foot beside the one link that opens it as transit directions in Google Maps                                                                 |
