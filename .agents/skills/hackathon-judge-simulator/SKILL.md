...
description: >-
  Simulate an adversarial judge panel scoring against the CodeNection rubric (25/20/15/15/15/10) with objections and predicted scores, including the 5-minute Q&A. Use to harden the submission before 13 Sept and the pitch before the Grand Finals.
---
